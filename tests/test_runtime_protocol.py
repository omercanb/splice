...
NOT_PRINTABLE = {
    ...
    "enumerate_iterator": "iteration state, never reachable from Python",
    "enumerate_view": "iteration state, never reachable from Python",
    "zip_iterator": "iteration state, never reachable from Python",
    "zip_view": "iteration state, never reachable from Python",
    "map_iterator": "iteration state, never reachable from Python",
    "map_view": "iteration state, never reachable from Python",
    "filter_iterator": "iteration state, never reachable from Python",
    "filter_view": "iteration state, never reachable from Python",
    "reversed_iterator": "iteration state, never reachable from Python",
    "reversed_view": "iteration state, never reachable from Python",
}
